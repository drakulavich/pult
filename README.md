...
The file is validated field by field before anything is printed, and a file that does not pass is treated as no data. The streak and the day are accepted up to 1500 minutes rather than 1440, because the day the clocks go back has 25 hours. The file format and this refresh contract are documented in zapara's spec, `docs/superpowers/specs/2026-09-19-zapara-status-file-design.md`.
